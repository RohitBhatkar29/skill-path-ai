...
const SignUp = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        if (res.success) {
            navigate('/assessment'); // Force new users to assessment
        } else {
            setError(res.error);
        }
    };
        ...
        <div className="min-h-screen bg-mint-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 transform transition-all">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">Join Skill Path AI</h2>
                    <p className="text-sm text-gray-500 mt-2">Start your personalized career journey</p>
                </div>
                ...
                <div className="mt-8 text-center text-sm text-gray-500">
                    ...
                    <Link to="/login" className="font-semibold text-mint-700 hover:text-mint-800">Login</Link>
                </div>
            </div>
        </div>
    );
